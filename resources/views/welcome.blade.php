  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-12 col-lg-8 col-xl-6 text-center">
        <img alt="image" width="200" src="images/logo/fat-cat-logo.png">
        <h2>Girls Fashion</h2>
        <p>#fashion #koreanfashion #fashiondenpasar</p>
      </div><!--end col-->
    </div><!--end row-->
  </div><!--end container-->
</section>

<section id="featured" class="fdb-block">
  <div class="container">
...
<section id="product">
    <div class="container">
        <h3>Newly Arrived</h3>
        <div class="newly-arrived-carousel">
