            ...
            <div class="sales-card col-lg-4 text-left">
                <div class="fdb-box p-0">
                    ...
                    <div class="d-flex justify-content-start">
                        ...
                        <p class="stats-text">Total Sales : &nbsp;</p>
                        @foreach($total_sales as $ts)
                            <p class="stats-text">Rp. {{ number_format($ts->total_sales, 0, ',', '.') }}</p>
                        @endforeach
                    </div>
                    <div class="d-flex justify-content-start">
                        <img class="profile-stats-icon" src="{{URL::asset('/images/logo/money.svg')}}" alt="...">
                        <p class="stats-text">Orders Completed : &nbsp;</p>
                        @foreach($total_orders_completed as $toc)
                        <p class="stats-text">{{$toc->orders_completed}}</p>
                        @endforeach
                    </div>
...
<section id="sales-pending-orders">
    <div class="container">
        ...
        <div class="sales-pending-orders-carousel">
            @foreach($orders_pending as $ord)
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><b>Order Id : {{$ord->id_order}} </b></h5>
                </div>
                <div class="card-body">
                    <p><b>Pembeli :</b> {{$ord->nama_pembeli}}</p>
                    <p><b>Kontak : </b>{{$ord->kontak_pembeli}}</p>
                    <p><b>Alamat Pengiriman : </b><br>{{$ord->alamat_pengiriman}}</p>
                  ...
                  <div class="d-flex justify-content-start">
                    ...
                    {{Form::hidden('_method','PUT')}}
                        {{Form::submit('Finish',['class'=>'btn btn-orders-finish'])}}
                    {!!Form::close()!!}
                    <script>
                            ...
                            e.preventDefault();
                            swal({
                            title: "Selesaikan order : {{$ord->id_order}} ?",
        ...
        <div class="sales-completed-orders-carousel">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Alamat Pengiriman : <br>{{$ordc->alamat_pengiriman}}</p>
                  <p class="card-text"><b>Items : </b></p>
                  <ul>
